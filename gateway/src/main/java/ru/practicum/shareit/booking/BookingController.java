...
public class BookingController {
    ...
    public ResponseEntity<Object> approveBooking(@RequestHeader("X-Sharer-User-Id") Integer owner,
                                        @PathVariable Integer bookingId,
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getAllBookingsByOwner(@RequestHeader("X-Sharer-User-Id") Integer owner,
                                                           @RequestParam(defaultValue = "all") String state) {
        return bookingClient.getAllBookingsByOwner(owner, state);
    }
}